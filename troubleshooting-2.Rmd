...
```{r}
### ERROR HERE ###
# The error here was that the movie lens were not grouped by the title, so the min/max ratings were based on the min/max in the entire data set and not by titles!!
movieLens %>%
  group_by(title) %>%
